...
def generate_launch_description() -> LaunchDescription:
    ...
    start_color_follow = LaunchConfiguration('start_color_follow')
    ...
    declarations = [
        ...
        DeclareLaunchArgument('start_color_follow', default_value='false'),
    ...
    color_follow_node = Node(
        condition=IfCondition(start_color_follow),
        package='turtlebot3_automation',
        executable='color_follow',
        name='color_follow',
        parameters=[color_config, {'use_sim_time': use_sim_time}],
        output='screen',
    )
    actions.append(color_follow_node)
